#!/usr/bin/env sh
# Universal installer for uaslog. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/uaslog.git"
echo "Installing uaslog ..."
